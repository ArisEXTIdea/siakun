...
<div id="main-container">
    <div id="header" class="w-full py-5 bg-violet-500">
        <h1 class="text-white text-center text-2xl font-bold">Registrasi Akun Baru</h1>
    </div>
        ...
        <div id="page-form" class="w-11/12 md:w-2/3 p-10 mt-10 rounded-lg drop-shadow-lg bg-white">
            <form action="/saveData" method="post" enctype="multipart/form-data">
                <div class="mt-3"> 
                    ...
                    <input type="text" name="name" class="px-5 py-3 border rounded w-full mt-3" placeholder="contoh: Muhammad Afrini">
                </div>
                <div class="mt-3">
                    <label for="email" class="font-semibold">Email</label>
                    <input type="email" name="email" class="px-5 py-3 border rounded w-full mt-3" placeholder="contoh: emailku@gmail.com">
                </div>
                <div class="mt-3">
                    <label for="password" class="font-semibold">Password</label>
                    <input type="password" name="password" class="px-5 py-3 border rounded w-full mt-3" placeholder="Masukkan Password">
                </div>
                <div class="mt-3">
                    <label for="address" class="font-semibold">Alamat</label>
                    <input type="text" name="address" class="px-5 py-3 border rounded w-full mt-3" placeholder="contoh: Jl. Gunung KILO">
                </div>
                <div class="mt-3">
                ...
                <div class="mt-3">
                    <label for="image" class="font-semibold">Profile Picture</label>
